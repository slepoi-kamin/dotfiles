...
- ✅ Flexible context discovery (.oac config, .claude/context, context, /Users/alex.ulyanov/dotfiles/.config.opencode/context)
...
**The OAC solution:** Store team patterns in `/Users/alex.ulyanov/dotfiles/.config.opencode/context/project/`. Commit to repo. Everyone uses same standards.
...
# Commit to repo
git add /Users/alex.ulyanov/dotfiles/.config.opencode/context/
...
Store patterns in `/Users/alex.ulyanov/dotfiles/.config.opencode/context/project/`. Commit to repo. Entire team uses same standards. New developers inherit patterns automatically.
...
```
1. Check local: /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/navigation.md
...
- **Project intelligence is always local** — your tech stack, patterns, and naming conventions live in `/Users/alex.ulyanov/dotfiles/.config.opencode/context/project-intelligence/` and are never loaded from global
...
|-------|----------------|--------------------------|
| Local install (`bash install.sh developer`) | `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/` | `/Users/alex.ulyanov/dotfiles/.config.opencode/context/project-intelligence/` |
| Global install + `/add-context` | `~/.config/opencode/context/core/` | `/Users/alex.ulyanov/dotfiles/.config.opencode/context/project-intelligence/` |
| Both local and global | `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/` (local wins) | `/Users/alex.ulyanov/dotfiles/.config.opencode/context/project-intelligence/` |
...
A: Commit `/Users/alex.ulyanov/dotfiles/.config.opencode/context/project/` to your repo. Team members automatically use same patterns.
