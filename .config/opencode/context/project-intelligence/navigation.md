...
```
/Users/alex.ulyanov/dotfiles/.config.opencode/context/project-intelligence/
...
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/project-intelligence.md` (standards and patterns)
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/system/context-guide.md` (context loading)

See `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/context-system.md` for the broader context architecture.
...
**Management Guide**: See `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/project-intelligence-management.md` for complete lifecycle management including:
...
See `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/project-intelligence.md` for the standard itself.
