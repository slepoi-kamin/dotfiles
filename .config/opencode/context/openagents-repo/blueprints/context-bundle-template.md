...
**Core Standards**:
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/code-quality.md` → Modular, functional code patterns
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/test-coverage.md` → Testing requirements and TDD
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/documentation.md` → Documentation standards
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/security-patterns.md` → Error handling, security patterns

**Core Workflows**:
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/task-delegation-basics.md` → Delegation process
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/feature-breakdown.md` → Task breakdown methodology
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/code-review.md` → Code review guidelines

## Repository-Specific Context (Load These Before Starting)

**Quick Start** (ALWAYS load first):
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/openagents-repo/quick-start.md` → Repo orientation and common commands

**Core Concepts** (Load based on task type):
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/openagents-repo/core-concepts/agents.md` → How agents work
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/openagents-repo/core-concepts/evals.md` → How testing works
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/openagents-repo/core-concepts/registry.md` → How registry works
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/openagents-repo/core-concepts/categories.md` → How organization works

**Guides** (Load for specific workflows):
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/openagents-repo/guides/adding-agent-basics.md` → Step-by-step agent creation
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/openagents-repo/guides/testing-agent.md` → Testing workflow
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/openagents-repo/guides/updating-registry.md` → Registry workflow
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/openagents-repo/guides/debugging.md` → Troubleshooting

**Lookup** (Quick reference):
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/openagents-repo/lookup/file-locations.md` → Where everything is
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/openagents-repo/lookup/commands.md` → Command reference
...
2. **Copy template**:
   ```bash
   cp /Users/alex.ulyanov/dotfiles/.config.opencode/context/openagents-repo/templates/context-bundle-template.md \
...
See `/Users/alex.ulyanov/dotfiles/.config.opencode/context/openagents-repo/examples/context-bundle-example.md` for a complete example.
