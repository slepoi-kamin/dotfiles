...
**Context** (`/Users/alex.ulyanov/dotfiles/.config.opencode/context/category/your-context.md`):
```yaml
---
...
```json
{
  ...
  "type": "context",
  "path": "/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/session-management.md",
  "aliases": [
    "workflows-sessions",
    "sessions"
  ],
