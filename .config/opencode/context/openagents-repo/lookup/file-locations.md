...
| **Context files** | `/Users/alex.ulyanov/dotfiles/.config.opencode/context/` |
...
| **New context** | `/Users/alex.ulyanov/dotfiles/.config.opencode/context/{category}/{name}.md` |
...
```
/Users/alex.ulyanov/dotfiles/.config.opencode/context/{category}/{topic}.md
```

**Examples**:
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/code-quality.md`
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/ui/web/react-patterns.md`
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/content-creation/principles/copywriting-frameworks.md`
...
```bash
# By category
ls /Users/alex.ulyanov/dotfiles/.config.opencode/context/{category}/

# All context
find /Users/alex.ulyanov/dotfiles/.config.opencode/context -name "*.md"
```
