...
**Core Standards**:
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/code.md` → Modular, functional code patterns
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/tests.md` → Testing requirements and TDD
- `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/docs.md` → Documentation standards
- (example: `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/patterns.md`) → Error handling, security patterns

**Core Workflows**:
- (example: `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/delegation.md`) → Delegation process
- (example: `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/task-breakdown.md`) → Task breakdown methodology
- (example: `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/review.md`) → Code review guidelines
