...
```bash
npx ts-node /Users/alex.ulyanov/dotfiles/.config.opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
