...
**Index Location**: `/Users/alex.ulyanov/dotfiles/.config.opencode/context/navigation.md` - Quick map of all contexts
...
**Central Index**: `/Users/alex.ulyanov/dotfiles/.config.opencode/context/navigation.md` - Ultra-compact map of all contexts
...
All files are in `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/` with organized subfolders:
...
- Load `/Users/alex.ulyanov/dotfiles/.config.opencode/context/navigation.md`
...
### /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/security-patterns.md
- Error handling
- Security patterns
- Common code patterns

### /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/code-analysis.md
- Analyzing codebase patterns
- Investigating bugs
- Evaluating architecture

### /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/task-delegation-basics.md
- Delegating to general agent
- Creating task context
- Multi-file coordination

### /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/feature-breakdown.md
- Tasks with 4+ files
- Estimated effort >60 minutes
- Complex dependencies

### /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/session-management.md
- Session lifecycle
- Cleanup procedures
- Session isolation
