...
**Rule**: If it's not in `/Users/alex.ulyanov/dotfiles/.config.opencode/context/`, use ExternalScout.
...
| **Location** | `/Users/alex.ulyanov/dotfiles/.config.opencode/context/` | Internet (Context7, docs) |
