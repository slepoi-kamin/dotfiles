...
├── .cache/
│   ├── test-coverage.md (cached from /Users/alex.ulyanov/dotfiles/.config.opencode/context/)
│   ├── code-quality.md
│   └── code-review.md
...
```json
{
  ...
  "cache": {
    "test-coverage.md": {
      "source": "/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/test-coverage.md",
...
IF cache exists AND cache is valid:
  ...
  SKIP re-reading from /Users/alex.ulyanov/dotfiles/.config.opencode/context/
ELSE:
  READ from /Users/alex.ulyanov/dotfiles/.config.opencode/context/
  CACHE the file
```
