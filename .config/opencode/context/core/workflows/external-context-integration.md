...
- Answer is in `/Users/alex.ulyanov/dotfiles/.config.opencode/context/` (use ContextScout instead)
...
- **External Context Management**: `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/external-context-management.md`
- **Task Delegation**: `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/task-delegation-basics.md`
