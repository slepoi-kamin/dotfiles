...
- **Task Delegation**: `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/task-delegation-basics.md` — How to reference external context in sessions
- **Session Management**: `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/session-management.md` — Session lifecycle
