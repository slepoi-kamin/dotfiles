...
**Purpose**: Copy context files from global (`~/.config/opencode/context/`) to local (`/Users/alex.ulyanov/dotfiles/.config.opencode/context/`) so they're project-specific and git-committed.
...
Local location: /Users/alex.ulyanov/dotfiles/.config.opencode/context/
...
If local `/Users/alex.ulyanov/dotfiles/.config.opencode/context/project-intelligence/` already exists:
...
Will copy to:   /Users/alex.ulyanov/dotfiles/.config.opencode/context/project-intelligence/
...
**Actions on approval:**
1. Create `/Users/alex.ulyanov/dotfiles/.config.opencode/context/project-intelligence/` if it doesn't exist
...
Copied 3 files to /Users/alex.ulyanov/dotfiles/.config.opencode/context/project-intelligence/
...
**Permission denied:**
```
Error: Cannot write to /Users/alex.ulyanov/dotfiles/.config.opencode/context/project-intelligence/
...
- Context path resolution: `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/system/context-paths.md`
