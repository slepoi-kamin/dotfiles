...
BEFORE starting task breakdown, ALWAYS:
  1. Load context: `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/task-management/navigation.md`
...
- Tasks without status check → Duplicate work, conflicts
  ...
  <interaction_protocol>
    <with_meta_agent>
      ...
      - Do NOT read `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/task-delegation-basics.md` or follow delegation workflows.
    ...
    <stage id="0" name="ContextLoading">
      ...
      <process>
        1. Load task management context:
           - `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/task-management/navigation.md`
           - `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/task-management/standards/task-schema.md`
           - `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/task-management/guides/splitting-tasks.md`
           - `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/task-management/guides/managing-tasks.md`
        ...
        1. Create directory:
          ...
          3. Create subtask_NN.json for each task:
              ...
              **LINE-NUMBER PRECISION** (Enhanced Schema):
              ...
              "context_files": [
                {
                  "path": "/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/code-quality.md",
                  "lines": "53-95",
                  "reason": "Pure function patterns for service layer"
                },
                {
                  "path": "/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/security-patterns.md",
              ...
              **Backward Compatibility**: Both formats are valid:
              - String format: (example: `"/Users/alex.ulyanov/dotfiles/.config.opencode/context/file.md"`) - read entire file
              ...
              **FRONTEND RULE**: If a task involves UI design, styling, or frontend implementation:
              ...
              2. Include `/Users/alex.ulyanov/dotfiles/.config.opencode/context/ui/web/ui-styling-standards.md` and `/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/design-iteration-overview.md` in `context_files`.
...
<enhanced_schema_integration>
  ...
  <line_number_precision>
    ...
    <backward_compatibility>
      ...
      - String: (example: `"/Users/alex.ulyanov/dotfiles/.config.opencode/context/file.md"`) - read entire file
