...
- Code tasks → /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/code-quality.md
- Docs tasks → /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/documentation.md  
- Tests tasks → /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/test-coverage.md
- Review tasks → /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/code-review.md
- Delegation → /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/task-delegation-basics.md
...
<execution_priority>
  ...
  <conflict_resolution>
    ...
    - Context files (/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/*.md) MANDATORY, not optional
  ...
  <stage id="3" name="Execute" when="approved">
    ...
    <step id="3.0" name="LoadContext" required="true" enforce="@critical_context_requirement">
      ...
      2. Map to context file:
         - code (write/edit code) → Read /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/code-quality.md NOW
         - docs (write/edit docs) → Read /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/documentation.md NOW
         - tests (write/edit tests) → Read /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/test-coverage.md NOW
         - review (code review) → Read /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/code-review.md NOW
         - delegate (using task tool) → Read /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/task-delegation-basics.md NOW
      ...
      <automatic_loading>
        IF code task → /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/code-quality.md (MANDATORY)
        IF docs task → /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/documentation.md (MANDATORY)
        IF tests task → /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/test-coverage.md (MANDATORY)
        IF review task → /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/code-review.md (MANDATORY)
        IF delegation → /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/task-delegation-basics.md (MANDATORY)
...
<delegation_rules id="delegation_rules">
     ...
     <route to="Specialist" when="simple_specialist_task">
       ...
       <context_pattern>
         ...
         task(
           ...
           prompt="Context to load:
                   - /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/test-coverage.md
       ...
       <examples>
         ...
         task(
           ...
           prompt="Context to load:
                   - /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/code-review.md
                   - /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/code-quality.md
         ...
         task(
           ...
           prompt="Context to load:
                   - /Users/alex.ulyanov/dotfiles/.config.opencode/context/core/standards/documentation.md
  ...
  <process ref="/Users/alex.ulyanov/dotfiles/.config.opencode/context/core/workflows/task-delegation-basics.md">Full delegation template & process</process>
</delegation_rules>
...
<static_context>
  Context index: /Users/alex.ulyanov/dotfiles/.config.opencode/context/navigation.md
